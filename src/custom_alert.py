...
class CustomAlert:
    ...
    def __init__(self, master,image_path):
        ...
        self.canvas.create_text(10, 140, anchor=tk.NW, text=python_files, fill="white",font = ("Arial", 14))
        self.canvas.create_text(10, 160, anchor=tk.NW, text=non_python_files, fill="white",font = ("Arial", 14))
        self.canvas.create_text(10, 180, anchor=tk.NW, text=config_files, fill="white",font = ("Arial", 14))
        self.canvas.create_text(10, 220, anchor=tk.NW, text=imports, fill="white",font = ("Arial", 14))
        self.canvas.create_text(10, 240, anchor=tk.NW, text=functions, fill="white",font = ("Arial", 14))
        self.canvas.create_text(10, 260, anchor=tk.NW, text=classes, fill="white",font = ("Arial", 14))
